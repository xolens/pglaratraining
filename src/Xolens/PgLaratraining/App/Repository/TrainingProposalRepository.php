...
use Xolens\LaratrainingContract\App\Contract\Repository\TrainingProposalRepositoryContract;
...
class TrainingProposalRepository extends AbstractWritableRepository implements TrainingProposalRepositoryContract
{
    ...
    public function validationRules(array $data){
        ...
        return [
            'name' => ['required',Rule::unique(PgLaratrainingCreateTableTrainingProposals::table())->where(function ($query) use($id, $name,$trainingCenterId) {
