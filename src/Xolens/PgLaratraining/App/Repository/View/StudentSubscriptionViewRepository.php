...
class StudentSubscriptionViewRepository extends AbstractReadableRepository implements StudentSubscriptionViewRepositoryContract
{
    ...
    public function paginateByStudent($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        ...
        $parentFilterer->equals(StudentSubscription::STUDENT_PROPERTY, $parentId);
    ...
    public function paginateByScholarship($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(StudentSubscription::SCHOLARSHIP_PROPERTY, $parentId);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
    }    
    
    public function paginateByScholarshipSorted($parentId, Sorter $sorter, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(StudentSubscription::SCHOLARSHIP_PROPERTY, $parentId);
        return $this->paginateSortedFiltered($sorter, $parentFilterer, $perPage, $page,  $columns, $pageName);
    }
    
    public function paginateByScholarshipFiltered($parentId, Filterer $filterer, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(StudentSubscription::SCHOLARSHIP_PROPERTY, $parentId);
        $parentFilterer->and($filterer);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
    ...
    public function paginateByScholarshipSortedFiltered($parentId, Sorter $sorter, Filterer $filterer, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(StudentSubscription::SCHOLARSHIP_PROPERTY, $parentId);
        $parentFilterer->and($filterer);
        return $this->paginateSortedFiltered($sorter, $parentFilterer, $perPage, $page,  $columns, $pageName);
